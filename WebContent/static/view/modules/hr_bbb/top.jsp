...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
	...
	<td class="topbg">
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
	    <tr>
		  <td height="50" class="toplink" align="right"><img src="${ctx}/static/resource/modules/hr_v12/images/top_home.gif">&nbsp;&nbsp;<a href="${ctx}/index">平台首页</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="${ctx}/static/resource/modules/hr_v12/images/top_exit.gif">&nbsp;&nbsp;<a href="javascript:void(0);" id="exit"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		</tr>
		<tr>
		  <td height="30" class="topnavbg">
		    <table width="100%" border="0" cellpadding="0" cellspacing="0">
			  <tr>
				...
				<td class="topnavlh" align="left"><img src="${ctx}/static/resource/modules/hr_v12/images/StatBar_admin.gif">&nbsp;&nbsp;当前用户：【${compnay}--${apperUserName} [${apperRealName}]】</td>
