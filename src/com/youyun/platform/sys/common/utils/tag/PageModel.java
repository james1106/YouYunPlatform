...
public class PageModel {
	...
	/** 每页分多少条数据   */
	private int pageSize = ApperSysConstants.PAGE_DEFAULT_SIZE = 4;
	...
	public int getPageSize() {
		this.pageSize = this.pageSize <= ApperSysConstants.PAGE_DEFAULT_SIZE? ApperSysConstants.PAGE_DEFAULT_SIZE : this.pageSize;
		return pageSize;
	}
